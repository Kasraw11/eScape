...
const PLACEHOLDER_KEY = "PASTE_YOUR_GOOGLE_MAPS_BROWSER_KEY_HERE";
...
const MELBOURNE_CBD_CENTER = { lat: -37.8136, lng: 144.9631 };

let mapsLoaderPromise;

export function hasConfiguredMapsKey(key) {
  return Boolean(key && key.trim() && key !== PLACEHOLDER_KEY);
}
